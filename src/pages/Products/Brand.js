...
const Banner = () => {
  ...
  const AddBanner = () => {
    ...
    axios
      .post(URLS.UpdateBrand, dataArray, {
  ...
  const DeleteBanner = data => {
    var token = datas
    var remid = { brand_id: data._id }
    axios
      .post(URLS.deleteBrand, remid, {
        headers: { Authorization: `Bearer ${token}` },
      })
      .then(
        res => {
  ...
  const searchAll = e => {
    ...
    axios
      .post(
        URLS.getBrandSearch + `${e.target.value}`,
        {},
  ...
  return (
    <React.Fragment>
      <div className="page-content">
        <Container fluid>
          <Breadcrumbs title="Whatnot" breadcrumbItem="Brand" />
