...
const UserProfile = () => {
  ...
  const changeHandler = e => {
    ...
    for (let i = 0; i < e.target.files.length; i++) {
      dataArray.append("admin_image", e.target.files[i])
    }
    axios
      .post(
        URLS.UpdateProfile,
  ...
  return (
    <React.Fragment>
      <div className="page-content">
        <Container fluid>
          <Breadcrumb title="Whatnot" breadcrumbItem="Profile" />
          {isLoading == true ? (
            <>
              <div style={{ zIndex: "9999999999999" }} className="text-center">
                <Card style={{ zIndex: "9999999999999", height: "550px" }}>
                  <CardBody>
                    <Spinner
                          ...
                          <Col md={2}>
                            <Link to="#" className="auth-logo-light">
                              <div className="avatar-md1 profile-user-wid mb-4">
                                <span className="ml-5">
                                  <img
                                    src={URLS.Base + admininfo.profilePicture}
                                    alt=""
                          ...
                          <Col md={4}>
                            <div className="mt-3">
                              <div className="row">
                                ...
                                <div className="col">
                                  <label>: {admininfo.username}</label>
                                  <br />
                          ...
                          <Row>
                            <Col sm="12">
                              <CardText className="mb-0">
                                ...
                                A personal profile is something that gives
                                whoever wants to hire you or needs your services
                                the first impression
                                <br /> that you are the best candidate for this
                                website.These sites take things to the next
                                level.
                                <Row className="mt-4">
                                  <Col md={8}>
                                    <Row>
